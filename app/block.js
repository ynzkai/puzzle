...
export default class Block extends React.Component {
  ...
  render() {
    return (
      <div className={css.block} onClick={(e) => {this.props.handleClick(e, this.props.seq)}} style={{top: this.props.pos.top, left: this.props.pos.left, width: this.props.width, height: this.props.height, opacity: (this.props.blank ? .05 : 1)}}>
